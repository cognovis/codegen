...
class Observation(DomainResource):
    ...
    basedOn: PyList[Reference[Literal["CarePlan", "DeviceRequest", "ImmunizationRecommendation", "MedicationRequest", "NutritionOrder", "ServiceRequest"]]] | None = Field(None, alias="basedOn", serialization_alias="basedOn")
    ...
    dataAbsentReason: CodeableConcept[Literal["unknown", "asked-unknown", "temp-unknown", "not-asked", "asked-declined", "masked", "not-applicable", "unsupported", "as-text", "error", "not-a-number", "negative-infinity", "positive-infinity", "not-performed", "not-permitted"] | str] | None = Field(None, alias="dataAbsentReason", serialization_alias="dataAbsentReason")
    derivedFrom: PyList[Reference[Literal["DocumentReference", "ImagingStudy", "Media", "MolecularSequence", "Observation", "QuestionnaireResponse"]]] | None = Field(None, alias="derivedFrom", serialization_alias="derivedFrom")
    device: Reference[Literal["Device", "DeviceMetric"]] | None = Field(None, alias="device", serialization_alias="device")
    ...
    partOf: PyList[Reference[Literal["ImagingStudy", "Immunization", "MedicationAdministration", "MedicationDispense", "MedicationStatement", "Procedure"]]] | None = Field(None, alias="partOf", serialization_alias="partOf")
    performer: PyList[Reference[Literal["CareTeam", "Organization", "Patient", "Practitioner", "PractitionerRole", "RelatedPerson"]]] | None = Field(None, alias="performer", serialization_alias="performer")
    referenceRange: PyList[ObservationReferenceRange] | None = Field(None, alias="referenceRange", serialization_alias="referenceRange")
    specimen: Reference[Literal["Specimen"]] | None = Field(None, alias="specimen", serialization_alias="specimen")
    ...
    subject: Reference[Literal["Device", "Group", "Location", "Patient"]] | None = Field(None, alias="subject", serialization_alias="subject")
    valueBoolean: bool | None = Field(None, alias="valueBoolean", serialization_alias="valueBoolean")
