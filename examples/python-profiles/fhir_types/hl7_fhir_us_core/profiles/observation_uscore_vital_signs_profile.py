...
class UscoreVitalSignsProfile:
    ...
    @classmethod
    def create(cls, *, category: list[CodeableConcept] | None = None, status: str, code: CodeableConcept, subject: Reference) -> "UscoreVitalSignsProfile":
    ...
    def set_status(self, value: str) -> "UscoreVitalSignsProfile":
    ...
    def set_vscat(self, value: dict) -> "UscoreVitalSignsProfile":
        match = self.__class__._vscat_slice_match
