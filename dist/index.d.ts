...
type TreeShakeDefaults = Pick<TreeShakeRule, "followReferences">;
...
type CodegenTag = "#binding" | "#largeValueSet" | "#placeholderValueSet" | "#fieldTypeNotFound" | "#skipCanonical" | "#duplicateSchema" | "#duplicateCanonical" | "#resolveBase" | "#resolveCollisionMiss" | "#nonMonotonicChoice" | "#canonicalManagerFallback";
