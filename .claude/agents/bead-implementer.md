...
description: Use when a bead execution owner needs exactly one admitted bead implemented
  inside an assigned worktree through vertical TDD slices as the current session of
  a stable logical implementation owner.
model: opus
requires_standards:
- executive-pack
- workflow
